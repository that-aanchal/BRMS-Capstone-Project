...
<html lang="en">
  ...
  <body>
            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
              <form action = "LoginController">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form1Example13" class="form-control form-control-lg"  name ="loginID" />
                ...
                <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a href="ur.jsp" class="btn btn-outline-primary">Create new</a>
                  </div>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container">
          <div class="row gy-4">
            <div class="col-lg-5 col-md-12 footer-info">
              ...
              <p>
                We offer bus reservation service online.<br/>Anyone can reserve bus
                ticket online throughout the country.
              </p>
            ...
            >
              ...
              <p>
                ...
                Maharashtra<br />
                India <br /><br />
                <strong>Phone:</strong> +91 1234567809<br />
                <strong>Email:</strong> bus@revature.com<br />
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>BRMS</span></strong
          >. All Rights Reserved
    </footer>
    <!-- End Footer -->
